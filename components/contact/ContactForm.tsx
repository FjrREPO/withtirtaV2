    ...
    >
      ...
      >
        <div className="group">
          <div className="relative overflow-hidden">
            <input
              ...
              disabled={isPending}
              className="peer w-full bg-transparent py-5 text-xl font-bold text-zinc-200 outline-none transition-colors duration-200 ease-in-out placeholder:text-zinc-200/50 dark:text-zinc-800 dark:placeholder:text-zinc-800/50 disabled:cursor-not-allowed disabled:opacity-50"
            />
        ...
        <div className="group">
          <div className="relative overflow-hidden">
            <textarea
              className="peer min-h-[11rem] w-full resize-none bg-transparent py-5 text-xl font-bold text-zinc-200 outline-none transition-colors duration-200 ease-in-out placeholder:text-zinc-200/50 dark:text-zinc-800 dark:placeholder:text-zinc-800/50 disabled:cursor-not-allowed disabled:opacity-50"
